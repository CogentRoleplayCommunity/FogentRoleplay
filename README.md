...
- [Fogent Roleplay Mechanics](#fogent-roleplay-mechanics)
  ...
  - [Item Tier](#item-tier)
    - [Base Dice Modification](#base-dice-modification)
...
|     Humanoid Swim Speed      |   15 ft (Base), +10 ft (per STR), +5 ft (per Swim)    |
