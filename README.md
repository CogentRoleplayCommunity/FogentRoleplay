...
Fogent Roleplay is a heavily modified version of Cogent Roleplay that was originally made for my first setting "Fallen".  Fallen + Cogent = Fogent.
...
All game mechanics and game systems built on top of Cogent Roleplay within this document are open and freely available for anyone to re-use, include, adapt or develop, in their own projects that are also based on Cogent Roleplay.
