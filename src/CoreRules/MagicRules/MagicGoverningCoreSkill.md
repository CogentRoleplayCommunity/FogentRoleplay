...
A magic governing core skill is used for instances when a character over exerts themselves with their magic, is trying to rapidly regain Magic Resource, or maintain a concentration on already cast spell.

* Magic that relies on the body to produce Magic Resource use Endurance as their governing core skill.
* Magic that relies on the mind or spirit to produce Magic Resource use Will as their governing core skill.
...
Certain magic spells demand your concentration to keep their effects active. If you lose this concentration, the spell's magic ends.
...
* Suffering damage. If you take damage while focusing on a spell, you must make a governing core skill check to maintain your concentration. The challenge level is equal to the level of injury taken. If you take damage from multiple sources, you make a separate saving throw for each injury source.
